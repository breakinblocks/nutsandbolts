...
mods.thaumcraft.Infusion.addRecipe("INFUSION", <AWWayofTime:demonBloodShard>, [<Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>, 
<Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>, <Thaumcraft:ItemShard:6>], "superbia 4, lux 16, alienis 4", <minecraft:nether_star>, 1);

//Guilty Pool
mods.thaumcraft.Infusion.addRecipe("INFUSION", <Botania:pool:3>, [<Thaumcraft:ItemEldritchObject:3>, <aura:blackHole>, <Botania:floatingSpecialFlower>.withTag({type: "kekimurus"}), <Botania:floatingSpecialFlower>.withTag({type: "entropinnyum"}), <AWWayofTime:transcendentBloodOrb>, <AWWayofTime:blockCrystalBelljar>.withTag({reagentTanks: [{amount: 16000, Reagent: "magicales", capacity: 16000}]}), <AWWayofTime:blockCrystalBelljar>.withTag({reagentTanks: [{amount: 16000, Reagent: "potentia", capacity: 16000}]}), <technom:manaFabricator>, <ThaumicTinkerer:kamiResource:5>, <bbtweaks:ItemAwakenedCore>], "superbia 40, praecantatio 320, potentia 64, auram 32", <Botania:pool:1>, 10);


//Infinity Egg
mods.thaumcraft.Infusion.addRecipe("INFUSION", <minecraft:dragon_egg>, [<witchery:ingredient:64>,<bbtweaks:ItemAwakenedCore>,<ExtraUtilities:pureLove>,<arsmagica2:flickerJar:9>, <witchery:deathshand>, <AWWayofTime:dawnScribeTool>], "alienis 128, praecantatio 128, potentia 64, auram 32", <witchery:infinityegg>, 12);
...
mods.thermalexpansion.Crucible.addRecipe(1000, <bbtweaks:ItemTarBall>, <liquid:oil> * 250);
...
mods.mekanism.Enrichment.addRecipe(<IC2:itemScrap>,<IC2:itemScrap>*4);
...
mods.mekanism.Enrichment.addRecipe(<IC2:itemPartCarbonMesh>, <IC2:itemPartCarbonPlate>);
...
//Auracascade
mods.auraCascade.Pylon.removeRecipe(<aura:consumerBlockplant>);
